module.exports.userList = function(rows) {
    ...
    for (row of rows) {
        ...
        users += `<td>${row.uid}</td>
                    ...
                    <a href="/user/update/uid${row.uid}"><i class="fas fa-key"></i>&nbsp
                    <a href="/user/update/uid${row.uid}"><i class="fas fa-trash-alt"></i></td>`;
...
<body>
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <img src="grid.png" class="d-inline-block align-top" alt="">&nbsp;&nbsp;&nbsp;
